...
import com.nas.alreem.fragment.reports.model.ReportResponseArray

class ReportListRecyclerAdapter(private var mContext:Context,private var reportslist: ArrayList<ReportDetailModel>):
