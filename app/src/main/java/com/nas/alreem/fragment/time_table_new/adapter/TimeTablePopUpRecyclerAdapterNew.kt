...
class TimeTablePopUpRecyclerAdapterNew (private var mContetx: Context, private var timeTableList: ArrayList<DayModelNew>) :
    RecyclerView.Adapter<TimeTablePopUpRecyclerAdapterNew.MyViewHolder>() {
