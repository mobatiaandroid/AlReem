...
internal class TimeTableSingleWeekSelectionAdapterNew (private var mContetx: Context, private var calendarArrayList: List<TimeTableApiListModelNew>) :
    RecyclerView.Adapter<TimeTableSingleWeekSelectionAdapterNew.MyViewHolder>() {
