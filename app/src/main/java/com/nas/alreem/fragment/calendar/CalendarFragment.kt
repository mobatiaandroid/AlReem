package com.nas.alreem.fragment.calendar
...
import com.nas.alreem.activity.calendar.CalendarTutorialActivity
...
//            activity?.startActivity(intent)
    ...
    private fun initialiseUI() {
        ...
        progressDialogAdd = view?.findViewById(R.id.progressDialogAdd) as ProgressBar
...
//        progressDialog = view?.findViewById(R.id.progressDialog) as ProgressBar
            ...
            override fun onResponse(
                ...
                progressDialogAdd.visibility = View.GONE
                    ...
                    if (response.body()!!.status == 100) {
                        ...
                        calendarDetailArrayList.addAll(response.body()!!.responseArray.data)
                            ...
                            for (i in 0..calendarDetailArrayList.size - 1) {
                                ...
                                for (j in 0..calendarDetailArrayList.get(i).details.size - 1) {
                                  ...
                                  xModel.status = calendarDetailArrayList.get(i).details.get(j).status
                                    ...
                                    xModel.isAllday = calendarDetailArrayList.get(i).details.get(j).isAllday.toString()
