package com.nas.alreem.fragment.contact_us.adapter
...
internal class ContactusAdapter(
    private var aboutuslist: List<ContactUsModel>,var context: Context
    ...
    override fun onCreateViewHolder(
        ...
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_contactus_list, parent, false)
