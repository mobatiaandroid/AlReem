...
class TimeTableAllWeekSelectionAdapter(
    private var mContext: Context,
    private var mPeriodModel: List<PeriodModelNew>,
    var timeTableAllRecycler: RecyclerView,
    var tipContainer: ToolTipLayout,
    private var mFeildList: List<FieldApiListModelNew>
) :
    RecyclerView.Adapter<TimeTableAllWeekSelectionAdapter.MyViewHolder>() {
...
//                )
                ...
                val mTimeTablePopUpRecyclerAdapter =
                    TimeTablePopUpRecyclerAdapterNew(
                        mContext,
        ...
        holder.tutor3.setOnClickListener {
            ...
            if (holder.tutor3.text == "") {
                ...
                llmAtime.orientation = LinearLayoutManager.VERTICAL
                recycler_view_timetable.layoutManager = llmAtime
                val mTimeTablePopUpRecyclerAdapter = TimeTablePopUpRecyclerAdapterNew(mContext,
