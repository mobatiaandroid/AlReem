...
class NewsLetterDetailAdapter (private var communicationList: ArrayList<String>, var context: Context) :
    RecyclerView.Adapter<NewsLetterDetailAdapter.MyViewHolder>() {
