...
class ClassRepresentativeRecyclerAdapter(
    private val mContext: Context,
    mnNewsLetterModelArrayList: ArrayList<TermsCalendarModel>
) :
    RecyclerView.Adapter<ClassRepresentativeRecyclerAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ClassRepresentativeRecyclerAdapter.MyViewHolder {
    ...
    override fun onBindViewHolder(
        holder: ClassRepresentativeRecyclerAdapter.MyViewHolder,
        position: Int
    ) {
