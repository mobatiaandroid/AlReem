...
class LostCardAdapter(
    private val mContext: Context,
    mnNewsLetterModelArrayList: ArrayList<PaymentWalletHistoryModel>
) :
    RecyclerView.Adapter<LostCardAdapter.MyViewHolder>() {
    private val mnNewsLetterModelArrayList: ArrayList<PaymentWalletHistoryModel>
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tripsDateTxt.setText(ConstantFunctions().dateConversionYY(mnNewsLetterModelArrayList[position].getDate_time()))
        holder.tripsAmountTxt.text =
            "Credit " + mnNewsLetterModelArrayList[position].getAmount() + " " + "AED"
